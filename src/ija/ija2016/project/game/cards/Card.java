...
public class Card extends ImageView implements ija.ija2016.project.model.cards.Card {
    ...
    public static Card.Color valueOf(String name) {
        ...
        //ija.ija2016.project.game.cards.Card.Color.values()[0].name()
    ...
    public Card(ija.ija2016.project.model.cards.Card.Color c, int value, boolean facingUp) {
        this.color = c;
        this.value = value;
    ...
    @Override
    public boolean similarColorTo(ija.ija2016.project.model.cards.Card c) {
        return this.color.similarColorTo(c.color());
    }

    @Override
    public int compareValue(ija.ija2016.project.model.cards.Card c) {
